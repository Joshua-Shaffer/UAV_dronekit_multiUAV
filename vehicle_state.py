...
vehicle = connect(connection_string, wait_ready=False, baud=57600 ,source_system=int(source_id))#,source_system=source_id)
...
while True:
    ...
    my_location_alt.alt = int(source_id)
...
while not vehicle.home_location:
    ...
    cmds.download()
    cmds.wait_ready(True, timeout=300)
